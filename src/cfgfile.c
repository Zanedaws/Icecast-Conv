...
static inline ice_config_http_header_t * config_copy_http_header(ice_config_http_header_t *header) {
    ...
    while (header) {
        ...
        cur->name   = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup(header->name), byte_count(4096));
        cur->value  = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup(header->value), byte_count(4096));
...
{
    configuration->location = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup (CONFIG_DEFAULT_LOCATION), byte_count(4096));
    configuration->server_id = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup (ICECAST_VERSION_STRING), byte_count(4096));
    configuration->admin = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup (CONFIG_DEFAULT_ADMIN), byte_count(4096));
    ...
    configuration->shoutcast_mount = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup (CONFIG_DEFAULT_SHOUTCAST_MOUNT), byte_count(4096));
    configuration->ice_login = CONFIG_DEFAULT_ICE_LOGIN;
    configuration->fileserve = CONFIG_DEFAULT_FILESERVE;
    configuration->touch_interval = CONFIG_DEFAULT_TOUCH_FREQ;
    configuration->on_demand = 0;
    configuration->dir_list = NULL;
    configuration->hostname = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup (CONFIG_DEFAULT_HOSTNAME), byte_count(4096));
    configuration->mimetypes_fn = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup (MIMETYPESFILE), byte_count(4096));
    configuration->master_server = NULL;
    configuration->master_server_port = 0;
    configuration->master_update_interval = CONFIG_MASTER_UPDATE_INTERVAL;
    configuration->master_username = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup (CONFIG_DEFAULT_MASTER_USERNAME), byte_count(4096));
    configuration->master_password = NULL;
    configuration->base_dir = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup (CONFIG_DEFAULT_BASE_DIR), byte_count(4096));
    configuration->log_dir = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup (CONFIG_DEFAULT_LOG_DIR), byte_count(4096));
    configuration->cipher_list = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup (CONFIG_DEFAULT_CIPHER_LIST), byte_count(4096));
    configuration->webroot_dir = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup (CONFIG_DEFAULT_WEBROOT_DIR), byte_count(4096));
    configuration->adminroot_dir = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup (CONFIG_DEFAULT_ADMINROOT_DIR), byte_count(4096));
    configuration->playlist_log = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup (CONFIG_DEFAULT_PLAYLIST_LOG), byte_count(4096));
    configuration->access_log = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup (CONFIG_DEFAULT_ACCESS_LOG), byte_count(4096));
    configuration->error_log = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup (CONFIG_DEFAULT_ERROR_LOG), byte_count(4096));
    ...
    configuration->relay_username = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup (CONFIG_DEFAULT_MASTER_USERNAME), byte_count(4096));
...
static void _parse_root(xmlDocPtr doc, xmlNodePtr node, 
        ice_config_t *configuration : itype(_Ptr<ice_config_t>))
{
    char *tmp;

    configuration->listen_sock = _Dynamic_bounds_cast<_Ptr<listener_t>>(calloc (1, sizeof (*configuration->listen_sock)));
    ...
    do {
        ...
        if (xmlStrcmp (node->name, XMLSTR("location")) == 0) {
            ...
            configuration->location = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
        } else if (xmlStrcmp (node->name, XMLSTR("admin")) == 0) {
            if (configuration->admin) xmlFree(configuration->admin);
            configuration->admin = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
        } else if (xmlStrcmp (node->name, XMLSTR("server-id")) == 0) {
            xmlFree (configuration->server_id);
            configuration->server_id = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
            ...
            configuration->source_password = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
            ...
            configuration->hostname = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
        } else if (xmlStrcmp (node->name, XMLSTR("mime-types")) == 0) {
            if (configuration->mimetypes_fn) xmlFree(configuration->mimetypes_fn);
            configuration->mimetypes_fn = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
            ...
            configuration->listen_sock->bind_address = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
        } else if (xmlStrcmp (node->name, XMLSTR("master-server")) == 0) {
            if (configuration->master_server) xmlFree(configuration->master_server);
            configuration->master_server = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
            ...
            configuration->master_username = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
            ...
            configuration->master_password = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
            ...
            configuration->shoutcast_mount = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
        ...
        ice_config_t *configuration)
{
    ...
    do {
        ...
        if (xmlStrcmp (node->name, XMLSTR("mount-name")) == 0) {
            mount->mountname = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString (doc, node->xmlChildrenNode, 1), byte_count(4096));
        }
        else if (xmlStrcmp (node->name, XMLSTR("username")) == 0) {
            mount->username = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(
                    doc, node->xmlChildrenNode, 1), byte_count(4096));
        }
        else if (xmlStrcmp (node->name, XMLSTR("password")) == 0) {
            mount->password = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(
                    doc, node->xmlChildrenNode, 1), byte_count(4096));
        }
        else if (xmlStrcmp (node->name, XMLSTR("dump-file")) == 0) {
            mount->dumpfile = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(
                    doc, node->xmlChildrenNode, 1), byte_count(4096));
        }
        else if (xmlStrcmp (node->name, XMLSTR("intro")) == 0) {
            mount->intro_filename = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(
                    doc, node->xmlChildrenNode, 1), byte_count(4096));
        }
        else if (xmlStrcmp (node->name, XMLSTR("fallback-mount")) == 0) {
            mount->fallback_mount = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(
                    doc, node->xmlChildrenNode, 1), byte_count(4096));
        }
            ...
            mount->charset = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc,
                    node->xmlChildrenNode, 1), byte_count(4096));
        }
            ...
            mount->on_connect = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(
                    doc, node->xmlChildrenNode, 1), byte_count(4096));
        }
        else if (xmlStrcmp (node->name, XMLSTR("on-disconnect")) == 0) {
            mount->on_disconnect = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(
                    doc, node->xmlChildrenNode, 1), byte_count(4096));
        }
            ...
            mount->cluster_password = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(
                    doc, node->xmlChildrenNode, 1), byte_count(4096));
        } else if (xmlStrcmp (node->name, XMLSTR("stream-name")) == 0) {
            mount->stream_name = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(
                    doc, node->xmlChildrenNode, 1), byte_count(4096));
        } else if (xmlStrcmp (node->name, XMLSTR("stream-description")) == 0) {
            mount->stream_description = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(
                    doc, node->xmlChildrenNode, 1), byte_count(4096));
        } else if (xmlStrcmp (node->name, XMLSTR("stream-url")) == 0) {
            mount->stream_url = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(
                    doc, node->xmlChildrenNode, 1), byte_count(4096));
        } else if (xmlStrcmp (node->name, XMLSTR("genre")) == 0) {
            mount->stream_genre = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(
                    doc, node->xmlChildrenNode, 1), byte_count(4096));
        } else if (xmlStrcmp (node->name, XMLSTR("bitrate")) == 0) {
            mount->bitrate = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(
                    doc, node->xmlChildrenNode, 1), byte_count(4096));
            ...
            mount->type = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(
                    doc, node->xmlChildrenNode, 1), byte_count(4096));
        } else if (xmlStrcmp (node->name, XMLSTR("subtype")) == 0) {
            mount->subtype = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(
                    doc, node->xmlChildrenNode, 1), byte_count(4096));
        } else if (xmlStrcmp (node->name, XMLSTR("http-headers")) == 0) {
        ...
        ice_config_t *configuration)
{
    ...
    relay->server = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup ("127.0.0.1"), byte_count(10));
    relay->mount = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlCharStrdup ("/"), byte_count(2));
    ...
    do {
        ...
        if (xmlStrcmp (node->name, XMLSTR("server")) == 0) {
            ...
            relay->server = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(
                    doc, node->xmlChildrenNode, 1), byte_count(4096));
        }
        else if (xmlStrcmp (node->name, XMLSTR("port")) == 0) {
            tmp = (char *)xmlNodeListGetString(doc, node->xmlChildrenNode, 1);
            ...
            relay->mount = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(
                    doc, node->xmlChildrenNode, 1), byte_count(4096));
        }
        else if (xmlStrcmp (node->name, XMLSTR("local-mount")) == 0) {
            if (relay->localmount) xmlFree (relay->localmount);
            relay->localmount = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(
                    doc, node->xmlChildrenNode, 1), byte_count(4096));
        }
            ...
            relay->username = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc,
                    node->xmlChildrenNode, 1), byte_count(4096));
        }
        else if (xmlStrcmp (node->name, XMLSTR("password")) == 0) {
            if (relay->password) xmlFree (relay->password);
            relay->password = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc,
                    node->xmlChildrenNode, 1), byte_count(4096));
        }
            ...
            relay->bind = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString (doc, node->xmlChildrenNode, 1), byte_count(4096));
        }
    } while ((node = node->next));
    if (relay->localmount == NULL)
        relay->localmount = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup (XMLSTR(relay->mount)), byte_count(4096));
}
        ...
        ice_config_t *configuration)
{
    ...
    do {
        ...
        if (xmlStrcmp (node->name, XMLSTR("port")) == 0) {
            ...
            if (listener->shoutcast_mount) xmlFree (listener->shoutcast_mount);
            listener->shoutcast_mount = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(1));
        }
        else if (xmlStrcmp (node->name, XMLSTR("bind-address")) == 0) {
            if (listener->bind_address) xmlFree (listener->bind_address);
            listener->bind_address = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, 
                    node->xmlChildrenNode, 1), byte_count(4096));
        }
    ...
    if (listener->shoutcast_mount)
    {
        ...
        sc_port->shoutcast_mount = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup (XMLSTR(listener->shoutcast_mount)), byte_count(4096));
        if (listener->bind_address)
            sc_port->bind_address = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup (XMLSTR(listener->bind_address)), byte_count(4096));
        ...
        if (xmlStrcmp (node->name, XMLSTR("source-password")) == 0) {
            if (xmlGetProp(node, XMLSTR("mount"))) {
                ...
                configuration->source_password = 
                    _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
            }
        ...
        ice_config_t *configuration)
{
    ...
    _Ptr<aliases> alias = NULL;
    _Ptr<aliases> current = NULL;
    _Ptr<aliases> last = NULL;
    ...
    do {
        ...
        if (xmlStrcmp (node->name, XMLSTR("basedir")) == 0) {
            ...
            configuration->base_dir = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
        } else if (xmlStrcmp (node->name, XMLSTR("logdir")) == 0) {
            if (!(temp = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096)))) {
            ...
            configuration->pidfile = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
        } else if (xmlStrcmp (node->name, XMLSTR("deny-ip")) == 0) {
            if (configuration->banfile) xmlFree(configuration->banfile);
            configuration->banfile = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
        } else if (xmlStrcmp (node->name, XMLSTR("allow-ip")) == 0) {
            if (configuration->allowfile) xmlFree(configuration->allowfile);
            configuration->allowfile = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
        } else if (xmlStrcmp (node->name, XMLSTR("ssl-certificate")) == 0) {
            if (configuration->cert_file) xmlFree(configuration->cert_file);
            configuration->cert_file = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
        } else if (xmlStrcmp (node->name, XMLSTR("ssl-allowed-ciphers")) == 0) {
            if (configuration->cipher_list) xmlFree(configuration->cipher_list);
            configuration->cipher_list = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
            ...
            configuration->adminroot_dir = temp;
            ...
            alias->next = NULL;
            alias->source = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlGetProp(node, XMLSTR("source")), byte_count(4096));
            if(alias->source == NULL) {
                free(alias);
                continue;
            }
            alias->destination = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlGetProp(node, XMLSTR("destination")), byte_count(4096));
            if (!alias->destination)
                alias->destination = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlGetProp(node, XMLSTR("dest")), byte_count(4096));
            if(alias->destination == NULL) {
                xmlFree(alias->source);
                free(alias);
                continue;
            }
            temp = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlGetProp(node, XMLSTR("port")), byte_count(4096));
            if(temp != NULL) {
                ...
                alias->port = -1;
            alias->bind_address = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlGetProp(node, XMLSTR("bind-address")), byte_count(4096));
        ...
        ice_config_t *configuration)
{
    ...
    do {
        ...
        if (xmlStrcmp (node->name, XMLSTR("accesslog")) == 0) {
            if (!(tmp = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096)))) {
            ...
            configuration->playlist_log = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
       ...
       if (xmlStrcmp (node->name, XMLSTR("chroot")) == 0) {
           ...
           do {
               ...
               if(xmlStrcmp (node->name, XMLSTR("user")) == 0) {
                   ...
                   configuration->user = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
               } else if(xmlStrcmp (node->name, XMLSTR("group")) == 0) {
                   if(configuration->group) xmlFree(configuration->group);
                   configuration->group = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlNodeListGetString(doc, node->xmlChildrenNode, 1), byte_count(4096));
               }
           } while((node = node->next));
           node = oldnode;
       }
...
static void merge_mounts(mount_proxy * dst, mount_proxy * src) {
    ...
    if (!dst->username)
    	dst->username = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup((xmlChar*)src->username), byte_count(4096));
    if (!dst->password)
    	dst->password = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup((xmlChar*)src->password), byte_count(4096));
    if (!dst->dumpfile)
    	dst->dumpfile = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup((xmlChar*)src->dumpfile), byte_count(4096));
    if (!dst->intro_filename)
    	dst->intro_filename = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup((xmlChar*)src->intro_filename), byte_count(4096));
    ...
    if (!dst->fallback_mount)
    	dst->fallback_mount = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup((xmlChar*)src->fallback_mount), byte_count(4096));
    ...
    if (!dst->charset)
    	dst->charset = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup((xmlChar*)src->charset), byte_count(4096));
    if (dst->mp3_meta_interval == -1)
    	dst->mp3_meta_interval = src->mp3_meta_interval;
    if (!dst->auth_type)
    	dst->auth_type = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup((xmlChar*)src->auth_type), byte_count(4096));
    // TODO: dst->auth
    if (!dst->cluster_password)
    	dst->cluster_password = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup((xmlChar*)src->cluster_password), byte_count(4096));
    // TODO: dst->auth_options
    if (!dst->on_connect)
    	dst->on_connect = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup((xmlChar*)src->on_connect), byte_count(4096));
    if (!dst->on_disconnect)
    	dst->on_disconnect = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup((xmlChar*)src->on_disconnect), byte_count(4096));
    if (!dst->max_listener_duration)
    	dst->max_listener_duration = src->max_listener_duration;
    if (!dst->stream_name)
    	dst->stream_name = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup((xmlChar*)src->stream_name), byte_count(4096));
    if (!dst->stream_description)
    	dst->stream_description = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup((xmlChar*)src->stream_description), byte_count(4096));
    if (!dst->stream_url)
    	dst->stream_url = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup((xmlChar*)src->stream_url), byte_count(4096));
    if (!dst->stream_genre)
    	dst->stream_genre = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup((xmlChar*)src->stream_genre), byte_count(4096));
    if (!dst->bitrate)
    	dst->bitrate = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup((xmlChar*)src->bitrate), byte_count(4096));
    if (!dst->type)
    	dst->type = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup((xmlChar*)src->type), byte_count(4096));
    if (!dst->subtype)
    	dst->subtype = _Assume_bounds_cast<_Nt_array_ptr<char>>(xmlStrdup((xmlChar*)src->subtype), byte_count(4096));
    if (dst->yp_public == -1)
