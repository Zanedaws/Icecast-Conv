...
int avl_delete (avl_tree *tree : itype(_Ptr<avl_tree>), void *        key : itype(_Ptr<void>), avl_free_key_fun_type free_key_fun : itype(_Ptr<int (void *)>));
...
int avl_get_span_by_key (avl_tree *tree : itype(_Ptr<avl_tree>), void *        key : itype(_Ptr<void>), unsigned long *low : itype(_Ptr<unsigned long>), unsigned long *high : itype(_Ptr<unsigned long>));

int avl_get_span_by_two_keys (avl_tree *tree : itype(_Ptr<avl_tree>), void *        key_a : itype(_Ptr<void>), void *        key_b : itype(_Ptr<void>), unsigned long *low : itype(_Ptr<unsigned long>), unsigned long *high : itype(_Ptr<unsigned long>));

int avl_verify (avl_tree *tree : itype(_Ptr<avl_tree>));

void avl_print_tree (avl_tree *tree : itype(_Ptr<avl_tree>), avl_key_printer_fun_type key_printer : itype(_Ptr<int (_Nt_array_ptr<char>, void *)>));
...
int avl_get_item_by_key_most (avl_tree *tree : itype(_Ptr<avl_tree>), void *        key, void **        value_address);

int avl_get_item_by_key_least (avl_tree *tree : itype(_Ptr<avl_tree>), void *        key, void **        value_address);
